  ...
  weeklyOffers: [
    {
      id: 102,
      name: 'Promo',
      description: '2 cajas de Vino Toro tinto 1 litro\nmás gaseosa Rumipal 2,25 ML',
      image: 'https://placehold.co/300x300/4CAF50/white?text=Promo',
      price: 5000
    }
  ]
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <a href="#offers" className="text-[#333333] hover:text-[#FF9800] transition-colors">Ofertas</a>
            </nav>
                    ...
                    {cart.map(item => (
                      <div key={item.id} className="flex items-center justify-between p-3 bg-[#F9F9F9] rounded-lg">
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-[#666666] mt-1 whitespace-pre-line">
                            {item.isOffer 
                              ? item.description
                              : item.optionName}
                          </p>
